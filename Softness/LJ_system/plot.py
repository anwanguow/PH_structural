...
i = num - 1
file_softness = "softness_2/softness_t_" + str(int(i)) + ".csv"
file_q6msd = ""

if set == 1:
    file_q6msd = "../../data/Traj/Set_2/T_" + str(int(i)) + "/nuc.log"
else:
    file_q6msd = "../../data/Traj/Set_2/T_" + str(int(i)) + "/nuc.log"

y_1 = np.zeros((sep), dtype="int")

y_2 = np.load("sep/sep_" + str(int(num - 1)) + ".npy", allow_pickle=True)
