...
Fig.3 is generated by the 'plot.py' script located in the 'Presentation' directory.

<img src="./fig/Fig_3.jpg" alt="barcode" title="barcode" width="350">
...
Fig.9a) and Fig.9b) are generated by 'plot.py' script located in the 'Softness/LJ\_system' directory. These two subgraphs corresponds to the following variables: a) num = 3, b) num = 6 in the code.

Fig.9c) is generated by 'plot.py' script located in the 'Softness/KA\_system/KA\_1' directory, and Fig.8d) is generated by 'plot.py' script located in the 'Softness/KA\_system/KA\_2' directory.

<img src="./fig/Fig_9.jpg" alt="four_representative" title="four_representative" width="750">

Fig.10a) is generated by 'plot\_avg\_si.py' script located in the 'Softness/LJ\_system' directory.

Fig.10b) is generated by 'plot\_avg\_softness.py' script located in the 'Softness/LJ\_system' directory.

<img src="./fig/Fig_10.jpg" alt="avg_solid_vs_faded" title="avg_solid_vs_faded" width="500">
...
Fig.18 is generated by 'plot.py' script located in the 'Softness/LJ\_system' directory, the same as Fig.8a) and Fig.8b), with the variable num = 1 to 10, respectively.

<img src="./fig/Fig_18.jpg" alt="all_traj" title="all_traj" width="800">
