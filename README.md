...
Fig.10b) is generated by 'LS\_system.py' script located in the 'Statistics/system' directory. Before runnung, please extract the corresponding 7z archive file (barcodes.7z) in the 'Statistics/system' directory to that same directory.
