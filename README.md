...
This is the code for article Persistent Homology for Structural Characterization in Disordered Systems, containing the implementation of all algorithms from the paper, the calculated results, and the Python code for visualizing all figures from the paper.
